...
class FoodTableViewController: UITableViewController {
    ...
    var foodNames = ["bread","donuts","egg","hamburger","hotdog","meat","milk","mushrooms","orange","soup","sushi"]
    var foodImages = ["bread","donuts","egg","hamburger","hotdog","meat","milk","mushrooms","orange","soup","sushi"]
